DROP AGGREGATE IF EXISTS find_min_and_max(integer);
DROP AGGREGATE IF EXISTS find_min_and_max(varchar);
DROP FUNCTION IF EXISTS find_min_and_max_func(state point, next integer);
DROP FUNCTION IF EXISTS find_min_and_max_final_func(state point);
DROP FUNCTION IF EXISTS find_min_and_max_funcs(state point, next varchar);
DROP FUNCTION IF EXISTS find_min_and_max_final_funcs(state point);
...
--as my initial condition states.
